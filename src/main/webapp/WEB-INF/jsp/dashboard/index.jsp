...
<html>
	...
	<div class="page-loading-overlay">
        ...
        <script src="<c:url value='/resources/xenon-theme/js/xenon-widgets.js' />"></script>
        <script src="<c:url value='/resources/xenon-theme/js/devexpress-web-14.1/js/globalize.min.js' />"></script>
        <script src="<c:url value='/resources/xenon-theme/js/devexpress-web-14.1/js/dx.chartjs.js' />"></script>
